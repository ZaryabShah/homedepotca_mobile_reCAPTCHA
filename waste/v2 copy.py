...
class HomeDepotRecaptchaSolver:
    ...
    def __init__(self, proxy=None, mobile_mode=True):
        ...
        self.mobile_mode = mobile_mode  # New mobile mode flag
    ...
    def generate_device_info(self):
        ...
        if self.mobile_mode:
            # Mobile device specs
            screen_configs = [
                (390, 844, 24),   # iPhone 12/13/14 
                (414, 896, 24),   # iPhone 11/XR
                (428, 926, 24),   # iPhone 12/13/14 Pro Max
                (375, 812, 24),   # iPhone X/XS/11 Pro
                (393, 851, 24),   # Samsung Galaxy S21
                (412, 915, 24),   # Samsung Galaxy S22
            ]
        ...
        device_data = {
            ...
            "screen": {
                ...
                "availWidth": width,
                "availHeight": height - (60 if self.mobile_mode else 40)  # Mobile has more UI chrome
            },
            "navigator": {
                "language": "en-CA",
    ...
    def _get_user_agent(self):
        """Generate appropriate user agent based on mobile mode"""
        if self.mobile_mode:
            mobile_agents = [
    ...
    def _get_fonts_list(self):
        """Get fonts list based on platform"""
        if self.mobile_mode:
    ...
    def _get_plugins_list(self):
        """Get plugins list based on platform"""
        if self.mobile_mode:
    ...
    def setup_session_headers(self):
        ...
        if self.mobile_mode:
            # Mobile-specific headers (from APK analysis)
            mobile_headers = {
                ...
                "origin": "capacitor://localhost",  # Mobile app origin
...
def main():
    ...
    print("Mobile reCAPTCHA Solver - Binance-Style HTTP Client Approach")
    print("=" * 70)
    
    # Initialize solver with mobile mode enabled
