...
.method public final s(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/z;->e(Lj$/time/temporal/l;)Ljava/lang/Long;
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/l;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->m(Lj$/time/temporal/l;)J
    ...
    sget-object v2, Lj$/time/o;->f:Lj$/time/o;

    invoke-static {v5, v6, v3, v2}, Lj$/time/LocalDateTime;->M(JILj$/time/o;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v2}, Lj$/time/LocalDateTime;->E()I
    ...
    invoke-static {v9, v10, v3, v2}, Lj$/time/LocalDateTime;->M(JILj$/time/o;)Lj$/time/LocalDateTime;
...
.method public final v(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/format/w;->l(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/w;->l(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v0, v5}, Lj$/time/format/w;->u(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;

    move-result-object v0

    .line 0
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->h()Lj$/time/format/f;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/f;->v(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    :try_start_0
    invoke-static/range {v12 .. v17}, Lj$/time/LocalDateTime;->K(IIIIII)Lj$/time/LocalDateTime;
