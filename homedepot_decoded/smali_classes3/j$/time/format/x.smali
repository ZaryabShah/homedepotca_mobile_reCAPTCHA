...
.method final h()Lj$/time/chrono/i;
    .locals 1
    ...
    iget-object v0, v0, Lj$/time/format/D;->c:Lj$/time/chrono/i;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/x;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->b()Lj$/time/chrono/i;
...
.method final o(Lj$/time/temporal/l;JII)I
    .locals 2
...
.method final r()V
    ...
    iget-object v1, v1, Lj$/time/format/D;->c:Lj$/time/chrono/i;

    iput-object v1, v2, Lj$/time/format/D;->c:Lj$/time/chrono/i;
...
.method final t(Lj$/time/format/E;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/i;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/D;->c:Lj$/time/chrono/i;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/D;->s(Lj$/time/format/E;Ljava/util/Set;)V
