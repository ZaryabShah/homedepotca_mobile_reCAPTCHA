...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/v;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Lj$/time/format/G;)V
    ...
    invoke-direct {p0, v0, v1}, Lj$/time/format/u;-><init>(Lj$/time/temporal/n;Ljava/lang/String;)V

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lj$/time/format/v;->f:Ljava/util/HashMap;
...
.method protected final a(Lj$/time/format/x;)Lj$/time/format/o;
    ...
    iget-object v1, p0, Lj$/time/format/v;->f:Ljava/util/HashMap;
    ...
    :cond_3
    invoke-virtual {v4, v11, v11}, Lj$/time/format/o;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v11}, Lj$/time/format/o;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final s(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/z;->f(Lj$/time/temporal/n;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/l;)Z
    ...
    invoke-static {v3}, Lj$/time/Instant;->y(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
    ...
    :cond_3
    sget-object v3, Lj$/time/format/v;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1}, Lj$/time/format/G;->s()I
