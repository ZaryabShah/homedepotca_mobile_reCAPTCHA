...
.method static G(Lj$/time/temporal/TemporalAccessor;)Z
    .locals 1

    .line 0
    invoke-static {p0}, Lj$/time/chrono/i;->p(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/i;
...
.method static I(Lj$/time/temporal/TemporalAccessor;)V
    .locals 1
...
.method static J(Lj$/time/LocalDate;)Lj$/time/temporal/q;
    .locals 4

    .line 0
    invoke-static {p0}, Lj$/time/temporal/g;->N(Lj$/time/LocalDate;)I

    move-result p0

    invoke-static {p0}, Lj$/time/temporal/g;->O(I)I
...
.method static K(Lj$/time/LocalDate;)I
    .locals 5
    ...
    invoke-virtual {p0, v0}, Lj$/time/LocalDate;->R(I)Lj$/time/LocalDate;
...
.method static synthetic L(Lj$/time/LocalDate;)I
    .locals 0
...
.method private static N(Lj$/time/LocalDate;)I
    .locals 4
...
.method public v(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/q;
    .locals 0

    invoke-interface {p0}, Lj$/time/temporal/l;->y()Lj$/time/temporal/q;
